...
export default function WallSingle(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(require('../../../../../public/assets/kaykit/Models/items/wallSingle.gltf.glb')) as unknown as GLTFResult
  return (
...
//useGLTF.preload(require('../../../../../public/assets/kaykit/Models/items/wallSingle.gltf.glb'))
