...
export default function SwordUncommon(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/items/sword_uncommon.gltf.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/items/sword_uncommon.gltf.glb')
