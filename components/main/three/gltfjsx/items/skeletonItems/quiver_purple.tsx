...
export default function QuiverPurple(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/items/skeleton_items/quiver_purple.gltf.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/items/skeleton_items/quiver_purple.gltf.glb')
