...
export default function Barrel(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/items/barrel.gltf.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/items/barrel.gltf.glb')
