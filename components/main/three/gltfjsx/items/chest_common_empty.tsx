...
export default function ChestCommonEmpty(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(require('../../../../../public/assets/kaykit/Models/items/chest_common_empty.gltf.glb')) as unknown as GLTFResult
  return (
...
//useGLTF.preload(require('../../../../../public/assets/kaykit/Models/items/chest_common_empty.gltf.glb'))
