...
export default function HexSandTransitionB(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(require('../../../../../public/assets/kaykit/Models/tiles/hex/gltf/hex_sand_transitionB.gltf.glb')) as unknown as GLTFResult
  return (
...
//useGLTF.preload(require('../../../../../public/assets/kaykit/Models/tiles/hex/gltf/hex_sand_transitionB.gltf.glb'))
