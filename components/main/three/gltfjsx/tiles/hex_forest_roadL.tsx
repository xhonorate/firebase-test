...
export default function HexForestRoadL(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(require('../../../../../public/assets/kaykit/Models/tiles/hex/gltf/hex_forest_roadL.gltf.glb')) as unknown as GLTFResult
  return (
...
//useGLTF.preload(require('../../../../../public/assets/kaykit/Models/tiles/hex/gltf/hex_forest_roadL.gltf.glb'))
