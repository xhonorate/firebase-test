...
export default function HexSandWaterBDetail(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/tiles/hex/gltf/hex_sand_waterB_detail.gltf.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/tiles/hex/gltf/hex_sand_waterB_detail.gltf.glb')
