...
export default function HexRockRoadE(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/tiles/hex/gltf/hex_rock_roadE.gltf.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/tiles/hex/gltf/hex_rock_roadE.gltf.glb')
