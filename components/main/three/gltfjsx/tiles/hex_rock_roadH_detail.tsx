...
export default function HexRockRoadHDetail(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/tiles/hex/gltf/hex_rock_roadH_detail.gltf.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/tiles/hex/gltf/hex_rock_roadH_detail.gltf.glb')
