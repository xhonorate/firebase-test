...
export default function KnightHeadC(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/characters/extra_heads/knightHeadC.gltf.glb') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/characters/extra_heads/knightHeadC.gltf.glb')
