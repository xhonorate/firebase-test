...
export default function MageHeadC(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF(require('../../../../../public/assets/kaykit/Models/characters/extra_heads/mageHeadC.gltf')) as unknown as GLTFResult
  return (
...
//useGLTF.preload(require('../../../../../public/assets/kaykit/Models/characters/extra_heads/mageHeadC.gltf')
