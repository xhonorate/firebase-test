...
export default function CharacterKnight(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials } = useGLTF('/assets/kaykit/Models/characters/character_knight.gltf') as unknown as GLTFResult
  return (
...
useGLTF.preload('/assets/kaykit/Models/characters/character_knight.gltf')
